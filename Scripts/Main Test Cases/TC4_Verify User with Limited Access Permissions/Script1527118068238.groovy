...
WebUI.setText(findTestObject('SignIn_OR/Page_SmartCloud  Login/input_email'), GlobalVariable.stag_uname_limit_email)
...
WebUI.setText(findTestObject('SignIn_OR/Page_SmartCloud  Login/input_password'), GlobalVariable.stag_uname_limit_pass)
...
WebUiBuiltInKeywords.verifyElementPresent(findTestObject('Menu_Limited_Access_OR/Page_SmartCloud/div_view_quiltMy Dashboardstim'), 
    0)

WebUiBuiltInKeywords.verifyElementPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_view_quiltMy Dashboards'), 
    0)
...
WebUiBuiltInKeywords.verifyElementPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_add_to_queueNew Dashboard'), 
    0)

WebUiBuiltInKeywords.verifyElementPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_time_to_leaveSmartPark'), 
    0)

WebUiBuiltInKeywords.click(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_time_to_leaveSmartPark'))

WebUiBuiltInKeywords.verifyElementPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_time_to_leaveSmart Park Da'), 
    0)

WebUiBuiltInKeywords.verifyElementNotPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_local_parkingDefine Sector'), 
    0)

WebUiBuiltInKeywords.verifyElementNotPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_local_parkingDefine Lots'), 
    0)

WebUiBuiltInKeywords.verifyElementNotPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_local_parkingDefine Bay Ty'), 
    0)

WebUiBuiltInKeywords.verifyElementPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_data_usageSmartData'), 
    0)

WebUiBuiltInKeywords.click(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_data_usageSmartData'))

WebUiBuiltInKeywords.verifyElementNotPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_device_hubSmartZone'), 
    0)

WebUiBuiltInKeywords.verifyElementNotPresent(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div_settingsSettings'), 
    0)

WebUI.click(findTestObject('Menu_Global_Access_OR/Page_SmartCloud/div'))

WebUI.click(findTestObject('Menu_Limited_Access_OR/Page_SmartCloud/span_VB'))

WebUI.click(findTestObject('Menu_Limited_Access_OR/Page_SmartCloud/a_Logout'))
